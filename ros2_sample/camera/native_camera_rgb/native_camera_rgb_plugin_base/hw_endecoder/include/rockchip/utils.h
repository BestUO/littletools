...
#define show_options(opt)                                                                                              \
    do { _show_options(sizeof(opt) / sizeof(OptionInfo), opt); } while (0)
...
MPP_RET read_image(RK_U8 *buf, FILE *fp, RK_U32 width, RK_U32 height, RK_U32 hor_stride, RK_U32 ver_stride,
                   MppFrameFormat fmt);
MPP_RET fill_image(RK_U8 *buf, RK_U32 width, RK_U32 height, RK_U32 hor_stride, RK_U32 ver_stride, MppFrameFormat fmt,
                   RK_U32 frame_count);
