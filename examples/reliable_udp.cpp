...
TEST_CASE("ReliableUDP_SplitCell")
{
    std::string s = "12345";
    ...
    CHECK(messages_infos[0].cell_info.cell_header.cell_payload_size == 2);
    ...
    CHECK(messages_infos[1].cell_info.cell_header.cell_payload_size == 2);
    ...
    CHECK(messages_infos[2].cell_info.cell_header.cell_payload_size == 1);
...
TEST_CASE("ReliableUDP_SplitCell_2")
{
    std::string s = "12345";
    ...
    CHECK(messages_infos[0].cell_info.cell_header.cell_payload_size == 5);
...
TEST_CASE("ReliableUDP_AssemblerCell")
{
    ...
    CellInfoHeader cell_info_header1 = {UUID::gen(), 0, 0, 2, 5};
    CellInfoHeader cell_info_header2 = {UUID::gen(), 1, 5, 2, 5};
    CHECK(assembler_cell.DealWithCellMessage(msg1.data(), cell_info_header1)
        == false);
    CHECK(assembler_cell.DealWithCellMessage(msg2.data(), cell_info_header2)
        == true);
...
TEST_CASE("ReliableUDP_Assembler")
{
    ...
    CHECK(assembler.DealWithCellMessage(
              CellInfoHeader{cell_id, 0, 0, 2, 5}, 0, msg1.data())
        == false);
    CHECK(assembler.DealWithCellMessage(
              CellInfoHeader{cell_id, 1, 5, 2, 5}, 0, msg2.data())
        == true);
